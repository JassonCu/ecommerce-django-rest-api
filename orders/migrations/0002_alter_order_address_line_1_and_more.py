...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='order',
            name='amount',
            field=models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Monto'),
        ),
        migrations.AlterField(
            model_name='order',
            name='city',
        ...
        migrations.AlterField(
            model_name='order',
            name='shipping_name',
            field=models.CharField(max_length=255, verbose_name='Nombre de envío'),
        ),
        migrations.AlterField(
            model_name='order',
            name='shipping_price',
            field=models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Precio de envío'),
        ),
        migrations.AlterField(
            model_name='order',
            name='shipping_time',
            field=models.CharField(max_length=255, verbose_name='Tiempo de envío'),
        ),
        migrations.AlterField(
            model_name='order',
        ...
        migrations.AlterField(
            model_name='order',
            name='status',
            field=models.CharField(choices=[('not_processed', 'Not Processed'), ('processed', 'Processed'), ('shipped', 'Shipping'), ('delivered', 'Delivered'), ('cancelled', 'Cancelled')], default='not_processed', max_length=50, verbose_name='Estado'),
        ),
        migrations.AlterField(
            model_name='order',
        ...
        migrations.AlterField(
            model_name='order',
            name='transaction_id',
            field=models.CharField(max_length=255, unique=True, verbose_name='ID de transacción'),
        ),
        migrations.AlterField(
            model_name='order',
            name='user',
        ...
        migrations.AlterField(
            model_name='orderitem',
            name='date_added',
            field=models.DateTimeField(default=datetime.datetime.now, verbose_name='Fecha de adición'),
        ),
        migrations.AlterField(
            model_name='orderitem',
            name='name',
        ...
        migrations.AlterField(
            model_name='orderitem',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='products.product', verbose_name='Producto'),
        ),
    ]
